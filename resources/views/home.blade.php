@extends('layouts.app') 
@section('content')
<div class="container mx-auto max-w-screen-l p-4">
    <!-- Start Heroes -->
        ...
        <div class="flex flex-col justify-between">
            ...
            <div class="bg-[#D9D9D9]">
                <div class="bg-[#141E38] p-2 text-right">
                    <a
                        href="#"
                        class="text-white underline underline-offset-2 italic"
                        >Cek Tiket saya</a
                    >
                </div>
                <div class="p-3">
        ...
        <div class="pt-3">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-20">
                <figure class="relative max-w-sm transition-all duration-300">
                    <img
                        class="rounded-lg"
                        src="{{ asset('assets/image/pesawat1.png') }}"
                        alt="Pesawat"
                    />
                    <figcaption
                ...
                <figure class="relative max-w-sm transition-all duration-300">
                    <img
                        class="rounded-lg"
                        src="{{ asset('assets/image/pesawat2.png') }}"
                        alt="Pesawat"
                    />
                    <figcaption
                        class="absolute px-4 text-lg text-white bottom-6 w-full flex flex-row justify-between items-center"
                ...
                <figure class="relative max-w-sm transition-all duration-300">
                    <img
                        class="rounded-lg"
                        src="{{ asset('assets/image/pesawat3.png') }}"
                        alt="Pesawat"
                    />
                    <figcaption
                        class="absolute px-4 text-lg text-white bottom-6 w-full flex flex-row justify-between items-center"
