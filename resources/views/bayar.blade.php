    ...
    <div class="container max-w-screen-lg lg:max-w-screen-xl mx-auto p-4">
        ...
        <div class="flex flex-col-reverse md:flex-row gap-5">
            <div class="flex flex-col p-5 bg-[#D9D9D9] w-full md:w-3/5">
                <h1 class="font-semibold text-lg">Metode Pembayaran</h1>
                <h1 class="font-semibold text-lg pt-5">Transfer Bank</h1>
                <div class="flex flex-col lg:flex-row lg:items-center gap-5">
                    <a href="?bca" class="border border-black rounded-lg hover:scale-105 duration-300 ease-in-out">
                        <img class="h-auto max-w-xs" src="{{asset('assets/image/bca.png')}}" alt="Bank BCA" />
                    </a>
                    <a href="?bni" class="border border-black rounded-lg hover:scale-105 duration-300 ease-in-out">
                        <img class="h-auto max-w-xs" src="{{asset('assets/image/bni.png')}}" alt="Bank BNI" />
                    </a>
                </div>
                <h1 class="font-semibold text-lg pt-5">Gopay / QRIS</h1>
                <div class="flex flex-col lg:flex-row lg:items-center gap-5">
                    <a href="?gopay" class="border border-black rounded-lg hover:scale-105 duration-300 ease-in-out">
                        <img class="h-auto max-w-xs" src="{{asset('assets/image/gopay.png')}}" alt="Gopay" />
                    </a>
                    <a href="?qris" class="border border-black rounded-lg hover:scale-105 duration-300 ease-in-out">
                        <img class="h-auto max-w-xs" src="{{asset('assets/image/qris.png')}}" alt="QRIS" />
                    </a>
                </div>
            </div>
