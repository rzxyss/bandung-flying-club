...
@section('content')
    <div class="container mx-auto max-w-screen-lg p-4 overflow-visible ">
        <div class="w-full flex flex-col justify-center items-center pb-10">
            <h1 class="font-semibold text-3xl py-2">Zenit Stol</h1>
        </div>

        <div class="flex flex-col md:flex-row w-full gap-5">
            <div class="w-full">
                <h1 class="font-semibold text-3xl pb-7">Spesifikasi Zenit Stol</h1>
            ...
            <div class="w-full">
                <img src="{{ asset('assets/image/pesawat3.png') }}" alt="News"
